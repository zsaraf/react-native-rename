...
export function foldersAndFiles(currentAppName, newName) {
  ...
  return [
    ...
    `ios/${nS_NewName}.xcodeproj/xcshareddata/xcschemes/${nS_CurrentAppName}Debug.xcscheme`,
    `ios/${nS_NewName}.xcodeproj/xcshareddata/xcschemes/${nS_CurrentAppName}Release.xcscheme`,
